...
const  DrawerStack = () => {
    return (
       ...
       <Stack.Screen
           name="AvailableAdd"
            component={AvailableAdd}/>
       <Stack.Screen
           name="AvailableForChicks"
            component={AvailableForChicks}/>
             <Stack.Screen
           name="EggsMenu"
            component={EggsMenu}/>
             <Stack.Screen
...
<Stack.Screen
           name="ChickenForRates"
            component={ChickenForRates}/>

<Stack.Screen
           name="eggsMenuForRate"
            component={eggsMenuForRate}/>

            <Stack.Screen
           name="ChicksForBroiler"
            component={ChicksForBroiler}/>
            <Stack.Screen
           name="GoldenMisriAdd"
            component={GoldenMisriAdd}/>
            <Stack.Screen
           name="GolderMisiShowAdd"
            component={GolderMisiShowAdd}/>
            <Stack.Screen
           name="EggsLayerAdd"
            component={EggsLayerAdd}/>
            <Stack.Screen
           ...
           name="CreateAddForEgssGolderMisri"
            ...
            <Stack.Screen
           name="AddForFarm"
            component={AddForFarm}/>
            <Stack.Screen
           name="createAddForFarm"
            component={createAddForFarm}/>

<Stack.Screen
           name="AddForLabour"
            component={AddForLabour}/>

<Stack.Screen
           name="createAddForLabour"
            component={createAddForLabour}/>
<Stack.Screen
           name="CreateAddForBroiler"
            component={CreateAddForBroiler}/>
<Stack.Screen
           name="newRateScreen"
            component={newRateScreen}/>
<Stack.Screen
           name="Cities"
            component={Cities}/>
<Stack.Screen
