        ...
        return(
            <View>
                    ...
                    <View style={s.tab}>
                        ...
                        <TouchableOpacity
                            onPress={()=> this.setVisibility(true,false,false,colors.yellow,colors.blue,colors.blue)}
                            style={[s.tabStyle,{backgroundColor:oneWayBack}]}>
                            <Text style={s.title}>One-way</Text>
                        </TouchableOpacity>

                        <TouchableOpacity 
                            onPress={()=> this.setVisibility(false,true,false,colors.blue,colors.yellow,colors.blue)}
                             style={[s.tabStyle,{backgroundColor:roundTripBack}]}>
                            <Text style={s.title}>Round-trip</Text>
                        </TouchableOpacity>

                        <TouchableOpacity 
                            onPress={()=> this.setVisibility(false,false,true,colors.blue,colors.blue,colors.yellow)}
