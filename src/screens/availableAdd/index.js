...
class Create extends React.Component{
    ...
    render(){
        const {showWeight,showType,showRate,showLess,showAddress,showCity,showPhone,showGrade,selectedNasal,selectedCity} = this.state ;
        return(
            <View>
                <ScrollView>
          ...
          {showType &&      <View>
            ...
            {showRate &&<View>
                ...
                image={circle} placeholder="Enter Rate"/>
            </View>}

            
            {showGrade &&<View>
                 <Text style={styles.text}>شہر جس کے ریٹ کے مطابق چکس سیل کرنا</Text>
