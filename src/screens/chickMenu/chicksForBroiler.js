                   ...
                   // onPress={()=> this.props.navigation.navigate(item.route)}
                    style={styles.touchcard}>
                        <View style={styles.likeView}>
                              <View style={{flex:3,marginRight:20,alignItems:'center'}}>
                                  ...
                                  <View style={[styles.line,{backgroundColor:'black',marginHorizontal:10,height:40}]}/>
                               <TouchableOpacity
                               style={{flex:1}}
                    ...
                    <View style={styles.row}>
                            ...
                            <View>
                                <View style={styles.row}>
                                    <Text >Weight</Text>
                                    <Text style={styles.blackText}>چیکس کی تعداد</Text>

                                </View>

                                <View style={styles.row}>
                                    <Text >Type</Text>
                                    <Text style={styles.blackText}>ریٹٹ</Text>

                                </View>

                                <View style={styles.row}>
                                    <Text >rate </Text>
                                    <Text style={styles.blackText}>ڈلیوری تاریخ</Text>
                            ...
                            <View>
                                ...
                                <View style={styles.row}>
                                    <Text >بس </Text>
                                    <Text style={styles.blackText}>بس</Text>
    ...
    render(){
        ...
        return(
            <View style={{flex:1,backgroundColor:colors.backColor}}>
                ...
                <TouchableOpacity 
                    onPress={()=> this.props.navigation.navigate('CreateAddForBroiler',{
                        from
                    })}
                    style={styles.btn}>
