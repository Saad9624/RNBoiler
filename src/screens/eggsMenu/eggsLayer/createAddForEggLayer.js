...
class Create extends React.Component{
    ...
    render(){
        const {showWeight,showType,showRate,showLess,showAddress,showCity,showPhone,showGrade,selectedNasal,
            selectedCity} = this.state ;
        return(
            <View>
                <ScrollView>
          ...
          {showType &&      <View>
            ...
            {showRate &&<View>
                ...
                <CustomTextInput image={circle} placeholder="Enter Rate"/>
            </View>}
