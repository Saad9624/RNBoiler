                   ...
                   // onPress={()=> this.props.navigation.navigate(item.route)}
                    ...
                    <View style={styles.row}>
                            ...
                            <View>
                                <View style={styles.row}>
                                    <Text >کپیسٹی</Text>
                                    <Text style={styles.blackText}>کپیسٹی</Text>
                            ...
                            <View>
                                ...
                                <View style={styles.row}>
                                    <Text >سٹوری</Text>
                                    <Text style={styles.blackText}>سٹوری</Text>

                                </View>

                                <View style={styles.row}>
                                    <Text >کرایہ</Text>
                                    <Text style={styles.blackText}>کرایہ</Text>
                    ...
                    >
                             <Text style={[styles.text,{alignSelf:'center',fontSize:15,marginVertical:10}]}>VIEW Full Add</Text>
    ...
    render(){
        ...
        return(
            <View style={{flex:1,backgroundColor:colors.backColor}}>
                ...
                <TouchableOpacity 
                    onPress={()=> this.props.navigation.navigate('createAddForFarm',{
                        from
                    })}
                    style={styles.btn}>
